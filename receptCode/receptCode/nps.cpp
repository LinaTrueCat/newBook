...
void Nps::showWish() const {
    switch (wish) {
    case 1: cout << "grecha" << endl; break;
    case 2: cout << "potato" << endl; break;
    case 3: cout << "surnuku" << endl; break;
    default: cout << "nothing specific" << endl;
    }
}

void Nps::showVegStatus() const {
    if (vegStatus) cout << "is vegetarian" << endl;
